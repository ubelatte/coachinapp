...
if st.session_state.submitted and not st.session_state.generated:
    ...
    coaching_prompt = f"""
You are a workplace coaching assistant. Generate a formal Workplace Coaching Report.

Incident Summary:
Begin with this sentence on its own line:
...
Now write a detailed, objective, and professional summary based on the supervisor's description below. Be sure to include:
- Timeline of events and point history
- Any mention of leave or return dates
- Mention if a Verbal Warning was issued
- A final sentence stating: "The estimated or associated cost of this issue is {latest['Estimated/Annual Cost']}." (only if cost is not blank)
